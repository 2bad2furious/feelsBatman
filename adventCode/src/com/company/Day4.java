...
public class Day4 {
    public static int solve() {
        ...
        for (String str : getInput().split("\n")) {
            ...
            codeAndSum = a[a.length - 1];
            keep = codeAndSum.split(Pattern.quote("["));
            code = Integer.parseInt(keep[0]);
            string2 = keep[1];
            arr = ArrayObject.getArray();

            for (char c : string.toCharArray()) {
                for (ArrayObject o : arr) {
                    if (o.getCharacter() == c) {
                        o.increase();
                        break;
                    }
            ...
            Arrays.sort(arr, (((o1, o2) -> o2.getCount() - o1.getCount())));
            string = "" + arr[0].getCharacter() + arr[1].getCharacter() + arr[2].getCharacter() + arr[3].getCharacter() + arr[4].getCharacter() + "]";
            boolean cond = (string.equals(string2));
    ...
    private static String getInput() {
        return "aczupnetwp-dnlgpyrpc-sfye-dstaatyr-561[patyc]\n" +
